...
function iniciarSesion(pass){
  ...
  cy.wait(1000);
  cy.screenshot('/v5.68/aleatorio/caso4/1-inicioSesion');
  cy.get('#ember5').click();
}
...
function ingresarSettingsCodeInjection(){
  ...
  cy.wait(1000);
  cy.screenshot('/v5.68/aleatorio/caso4/2-setting');
...
function writeText(){
  ...
  cy.wait(2000);
  cy.screenshot('/v5.68/aleatorio/caso4/3-write');
...
function validarHeaderFooter(){
  ...
  cy.wait(2000);
  cy.screenshot('/v5.68/aleatorio/caso4/4-validate');
}
