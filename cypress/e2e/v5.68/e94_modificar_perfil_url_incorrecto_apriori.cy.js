describe('Perfil', function() {
    it('Modificar y validar acciones de mi perfil de ghost', function() {
        ...
        inciarSesion();
        cy.screenshot('/v5.68/caso94/1admin.png');
        cy.wait(2000);
        ingresarPerfil();
        editarPerfil();
  ...
  function inciarSesion(){
    ...
    cy.wait(1000);
    cy.screenshot('/v5.68/caso94/2homepage.png');
    cy.get('#ember5').click();
  }
  ...
  function editarPerfil(){
    ...
    cy.screenshot('/v5.68/caso94/6perfilNoEditado.png');
  }
