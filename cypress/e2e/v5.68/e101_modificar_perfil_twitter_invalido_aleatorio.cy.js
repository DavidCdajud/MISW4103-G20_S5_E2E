...
describe('Perfil', function() {
  it('Modificar y validar acciones de mi perfil de ghost', function() {
    ...
    inciarSesion();
    cy.screenshot('/v5.68/caso101/1admin.png');
    cy.wait(2000);
    ingresarPerfil();
    editarPerfil();
  })
...
function inciarSesion() {
  ...
  cy.wait(1000);
  cy.screenshot('/v5.68/caso101/2homepage.png');
  cy.get('#ember5').click();
}
...
function ingresarPerfil() {
  ...
  cy.wait(3000);
  cy.screenshot('/v5.68/caso101/3profile.png');
}

function editarPerfil() {
  cy.screenshot('/v5.68/caso101/4datos.png');
  ...
  cy.get('#user-twitter').type(fakeTwitter);
  
  cy.screenshot('/v5.68/caso101/5datosEditados.png');
  cy.wait(2000);
  ...
  cy.screenshot('/v5.68/caso101/6perfilNoEditado.png');
}