...
describe('Perfil', function() {
  ...
  function inciarSesion() {
    ...
    cy.wait(1000);
    cy.screenshot('/v5.68/caso102/2homepage.png');
    cy.get('#ember5').click();
  }
  ...
  function ingresarPerfil() {
    ...
    cy.wait(3000);
    cy.screenshot('/v5.68/caso102/3profile.png');
  }
  
  function editarPerfil() {
    cy.screenshot('/v5.68/caso102/4datos.png');
    ...
    cy.get('#user-twitter').type(fakeRandom);
    
    cy.screenshot('/v5.68/caso102/5datosEditados.png');
    cy.wait(2000);
    ...
    cy.screenshot('/v5.68/caso102/6perfilNoEditado.png');
  }