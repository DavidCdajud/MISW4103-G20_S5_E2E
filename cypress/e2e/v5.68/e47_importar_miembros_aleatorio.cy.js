describe('miembro', function() {
    it('importar miembros', function() {
        ...
        inciarSesion();
        cy.screenshot('/v5.68/caso27/1admin.png');
        cy.wait(2000);
        ingresarMiembros();
  ...
  function inciarSesion(){
    ...
    cy.wait(1000);
    cy.screenshot('/v5.68/caso27/2homepage.png');
    cy.get('#ember5').click();
  }
  function ingresarMiembros(){
    ...
    cy.screenshot('/v5.68/caso27/3miembros.png');
    ...
    cy.wait(1000);
    cy.screenshot('/v5.68/caso27/4cargaArchivo.png');
