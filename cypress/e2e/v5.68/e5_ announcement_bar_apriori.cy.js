...
function iniciarSesion(pass){
  ...
  cy.wait(1000);
  cy.screenshot('/v5.68/caso5/apriori/1-inicioSesion');
  cy.get('#ember5').click();
}
...
function ingresarSettingsAnnouncement(){
  ...
  cy.wait(1000);
  cy.screenshot('/v5.68/caso5/apriori/2-setting');
...
function writeText(){
  ...
  cy.wait(2000);
  cy.screenshot('/v5.68/caso5/apriori/3-write');
  cy.wait(2000);
...
function validarAnnouncementBar(){
  ...
  cy.wait(2000);
  cy.screenshot('/v5.68/caso5/apriori/4-validate');
}
